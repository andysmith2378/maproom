...
landKindList = [maproom.AcidGrassland, maproom.Pasture, maproom.RoughGrassland, maproom.Saltmarsh, 
                maproom.Farmland, maproom.Supralittoral, maproom.Heather, maproom.BroadleafWoodland, 
                maproom.Highland, maproom.ConiferousWoodland, maproom.CalcareousGrassland, maproom.Bog]
